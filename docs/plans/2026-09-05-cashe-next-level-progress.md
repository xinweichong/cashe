...
- Reuses migration 4 from the preceding uncommitted slice; no additional schema change or frontend change. No production services/data were modified. This verified slice is committed separately.
