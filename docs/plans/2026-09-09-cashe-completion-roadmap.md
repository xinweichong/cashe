...
**Status (2026-09-09): revisions, mutation/deletion history, and the typed v2 create/update/delete endpoints are done; broader command unification is not started.**
