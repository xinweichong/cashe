...
- Legacy financial scores/advice where required observations are absent — `get_health_score`'s existing `has_income_data` guard covers the no-income case; a broader review for other qualify/remove cases hasn't been done.
