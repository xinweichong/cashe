...
- Exit checks not yet exercised: the same-fixture-equal-money-on-Home/Explore/Activity/Telegram/exports check (money is now consistently *correct* everywhere, but nothing asserts the same fixture produces byte-identical numbers across every surface), and refunds-across-months/transfers/sparse-income/timezone/end-of-short-month parity specifically for the newly-fixed consumers.
