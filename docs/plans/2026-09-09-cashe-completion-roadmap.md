...
Remaining R06 sub-project not yet started: duplicate detection/merge — the largest and most complex of the original five, with merge/unmerge, a chosen survivor, preserved source IDs, and reversible decisions across category/split/trip/recurring conflicts.
